...
ct_files_path = '/Users/chunyang/projects/particle/data/Segmentations/072_interpolated/*'
particle_df_path = "../data/Velocity/072_velocity_points_newversion_bp1_tsr6tm1tml20_surface_masked.csv"  # noqa

pore_tif_path = "/Users/chunyang/projects/particle/data/rock/001_064_RobuGlass3_rec_16bit_abs_ShiftedDown18Left7_compressed_072.tif"

# csv with offset applied:
particle_df_path = "/Users/chunyang/projects/particle/data/Velocity_kalman/072.csv"  # noqa
...
if __name__ == "__main__":
    ...
    # shift = np.array([50, 50, -450]).reshape(-1, 3)
    ...
    plotter = explorer.plotter
    plotter.show_axes = False

    # set time slider
    explorer.set_scene3d(3)
