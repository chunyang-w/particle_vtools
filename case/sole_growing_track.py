...
python case/sole_growing_track.py \
    --particle_ground_df_path '/Users/chunyang/projects/particle/data/Velocity_kalman/155.csv' \
    --ct_files_path '/Users/chunyang/projects/particle/data/Segmentations/155_segmented_cleaned_filtered_cropped_interpolated/*' \
    --frame_start 0 \
    --frame_end 200 \
    --show_meniscus \
    --show_particle \
